  ...
  "/api/settings/ntfy": {
    ...
    put: {
      ...
      responses: {
        ...
        "422": {
          description:
            "Body matched neither accepted shape, or `enabled` is true while the stored config has no server URL and topic; or the server URL is on a private network the operator has not listed in `NOTIFICATION_PRIVATE_ORIGINS` (`meta.errorCode` = `private_origin_not_approved`). Nothing was stored.",
          content: { "application/json": { schema: errorEnvelope } },
        },
      },
    },
  ...
  "/api/settings/webhook": {
    ...
    put: {
      ...
      responses: {
        ...
        "422": {
          description:
            "Body matched neither accepted shape, or `enabled` is true while no webhook URL is stored; or the URL is on a private network the operator has not listed in `NOTIFICATION_PRIVATE_ORIGINS` (`meta.errorCode` = `private_origin_not_approved`). Nothing was stored.",
          content: { "application/json": { schema: errorEnvelope } },
        },
      },
    },
  ...
  "/api/settings/ntfy/test": {
    post: {
      ...
      responses: {
        ...
        "422": {
          description:
            "The saved server is on a private network the operator has not approved (`meta.errorCode` = `private_origin_not_approved`). The resolved address is never echoed.",
          content: { "application/json": { schema: errorEnvelope } },
        },
      },
    },
  ...
  "/api/settings/webhook/test": {
    post: {
      ...
      responses: {
        ...
        "422": {
          description:
            "The saved URL is on a private network the operator has not approved (`meta.errorCode` = `private_origin_not_approved`). The resolved address is never echoed.",
          content: { "application/json": { schema: errorEnvelope } },
        },
      },
    },
