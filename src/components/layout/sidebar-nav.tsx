    ...
    return (
      <div className="border-sidebar-border border-t p-3">
        <div className="flex items-center justify-center">
          <DropdownMenu>
            <DropdownMenuTrigger className="hover:bg-accent shrink-0 rounded-md p-1.5 transition-colors focus:outline-none">
  ...
  return (
    <div className="border-sidebar-border border-t p-3">
      <div className="flex items-center gap-3 px-2 py-1">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="text-muted-foreground hover:text-foreground hover:bg-accent shrink-0 rounded-md p-1.5 transition-colors focus:outline-none">
        ...
        >
          {collapsed ? (
            ...
            <div className="relative mb-1">
              <p className="text-foreground/60 px-3 text-xs font-semibold tracking-wider uppercase">
                {t("nav.home")}
              </p>
