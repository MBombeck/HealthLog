# v1.4.34.4 → v1.4.38.3 — Audit-Marathon Closure (extended)

Shipped: 2026-05-17 → 2026-05-18 (twelve consecutive releases capped by the v1.4.38.x iOS-coord chain — PR #190 admin-merge, six-axis QA, mood-reminder hotfix bundle, CI green-up + chunk-load auto-recover).
